...
typedef enum
{
	kGCDrawingInfoPlaceBottomRight		= 0,
	kGCDrawingInfoPlaceBottomLeft		= 1,
	kGCDrawingInfoPlaceTopLeft			= 2,
	kGCDrawingInfoPlaceTopRight			= 3
}
DKInfoBoxPlacement;
...
extern NSString*	kGCDrawingInfoTextLabelAttributes;
